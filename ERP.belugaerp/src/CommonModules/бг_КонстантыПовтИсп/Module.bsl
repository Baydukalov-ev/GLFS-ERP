...
Функция ЗначениеКонстанты(Идентификатор, Разрез = Неопределено) Экспорт
	Возврат РегистрыСведений.бг_ЗначенияДополнительныхКонстант.ЗначениеКонстанты(Идентификатор, Разрез);
КонецФункции
...
Функция ЗначенияКонстант(ИдентификаторыСтрокой) Экспорт
	Возврат РегистрыСведений.бг_ЗначенияДополнительныхКонстант.ЗначенияКонстант(ИдентификаторыСтрокой);
КонецФункции
...
Функция ФункциональнаяОпцияИспользуется(Идентификатор) Экспорт	
	Возврат РегистрыСведений.бг_ЗначенияДополнительныхКонстант.ФункциональнаяОпцияИспользуется(Идентификатор);
КонецФункции
...
Функция ОписаниеКонстанты(Идентификатор) Экспорт
	Возврат Справочники.бг_ДополнительныеКонстанты.ОписаниеКонстанты(Идентификатор);
КонецФункции
...
Функция ТаблицаОписанияКонстант() Экспорт
	Возврат Справочники.бг_ДополнительныеКонстанты.ТаблицаОписанияКонстант();
КонецФункции
