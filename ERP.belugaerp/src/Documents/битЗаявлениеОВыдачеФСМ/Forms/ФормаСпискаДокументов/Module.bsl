...
&НаКлиенте
Процедура ЗапроситьФСМ(Команда)
...
Процедура УстановитьУсловноеОформление()
	...
	СписокСтатусов.ЗагрузитьЗначения(Документы.битЗаявлениеОВыдачеФСМ.СтатусыОшибок());
	...
	СписокДействий.ЗагрузитьЗначения(Документы.битЗаявлениеОВыдачеФСМ.ВсеТребующиеОжидания());
...
Функция ВсеТребующиеДействия()
	...
	Возврат Документы.битЗаявлениеОВыдачеФСМ.ВсеТребующиеДействия();
...
Функция ВсеТребующиеОжидания()
	...
	Возврат Документы.битЗаявлениеОВыдачеФСМ.ВсеТребующиеОжидания();
