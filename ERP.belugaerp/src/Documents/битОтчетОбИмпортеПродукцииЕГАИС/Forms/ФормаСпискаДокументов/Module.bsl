...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИнтеграцияЕГАИСКлиентСервер.ОтборПоЗначениюСпискаПриСозданииНаСервере(СписокКОформлению, "ДокументОснование",    ДокументОснование,    СтруктураБыстрогоОтбора);
...
&НаКлиенте
Процедура ОтправитьОтчетОбИмпорте(Команда)
...
&НаКлиенте
Процедура ОтменитьОтчетОбИмпорте(Команда)
	ИнтеграцияЕГАИСКлиент.ПодготовитьСообщенияКПередаче(
		Элементы.Список,
...
Процедура УстановитьУсловноеОформление()
	...
	СписокСтатусов.ЗагрузитьЗначения(Документы.битОтчетОбИмпортеПродукцииЕГАИС.СтатусыОшибок());
	...
	СписокДействий.ЗагрузитьЗначения(Документы.битОтчетОбИмпортеПродукцииЕГАИС.ВсеТребующиеОжидания());
...
Функция ВсеТребующиеДействия()
	...
	Возврат Документы.битОтчетОбИмпортеПродукцииЕГАИС.ВсеТребующиеДействия();
...
Функция ВсеТребующиеОжидания()
	...
	Возврат Документы.битОтчетОбИмпортеПродукцииЕГАИС.ВсеТребующиеОжидания();
...
Процедура ОформитьОтчетОбИмпорте(Команда)
	...
	ИнтеграцияЕГАИСКлиент.ВыполнитьКомандуГиперссылки(
		...
		"СоздатьОтчетОбИмпортеПродукцииЕГАИС",
		ЭтотОбъект);
...
Процедура Архивировать(Команда)
	...
	ИнтеграцияИСКлиент.АрхивироватьРаспоряжения(ЭтотОбъект, Элементы.СписокКОформлению, ИнтеграцияЕГАИСКлиент,
		ПредопределенноеЗначение("Документ.битОтчетОбИмпортеПродукцииЕГАИС.ПустаяСсылка"));
