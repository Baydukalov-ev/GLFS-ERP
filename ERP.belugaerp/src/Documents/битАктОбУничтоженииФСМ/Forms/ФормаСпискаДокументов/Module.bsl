...
&НаКлиенте
Процедура ОтправитьАктОбУничтожении(Команда)
...
&НаКлиенте
Процедура ОтменитьАктОбУничтожении(Команда)
...
Процедура УстановитьУсловноеОформление()
	...
	СписокСтатусов.ЗагрузитьЗначения(Документы.битАктОбУничтоженииФСМ.СтатусыОшибок());
	...
	СписокДействий.ЗагрузитьЗначения(Документы.битАктОбУничтоженииФСМ.ВсеТребующиеОжидания());
...
Функция ВсеТребующиеДействия()
	...
	Возврат Документы.битАктОбУничтоженииФСМ.ВсеТребующиеДействия();
...
Функция ВсеТребующиеОжидания()
	...
	Возврат Документы.битАктОбУничтоженииФСМ.ВсеТребующиеОжидания();
...
Процедура Архивировать(Команда)
	...
	ИнтеграцияИСКлиент.АрхивироватьРаспоряжения(
		...
		ПредопределенноеЗначение("Документ.битАктОбУничтоженииФСМ.ПустаяСсылка"));
