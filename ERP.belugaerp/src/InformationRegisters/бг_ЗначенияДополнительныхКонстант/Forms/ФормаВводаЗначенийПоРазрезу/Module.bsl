...
Процедура ЗаполнитьЗначенияКонстанты()
	...
	ЗначенияКонстант = РегистрыСведений.бг_ЗначенияДополнительныхКонстант.ЗначенияВсехКонстант();
...
Функция СохранитьЗначенияСервер()
	...
	РегистрыСведений.бг_ЗначенияДополнительныхКонстант.УстановитьЗначенияКонстантыСРазрезом(
		ДанныеКонстанты.Константа,
